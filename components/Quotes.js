...
export default function Quotes() {
  ...
  return (
    <div className="mx-auto flex w-full flex-col items-center">
      <div className="inline-flex h-[300px] max-w-[500px] flex-col items-start justify-start gap-4 overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 shadow-md">
