    ...
    <Layout>
      <div className="-mt-20 bg-neutral-800">
        ...
        <ImageCard
          ...
          body={
            "The Pollution Control Department (PCD) is a government agency under the Ministry of Natural Resources and Environment (MONRE) of Thailand. The PCD is responsible for regulating air pollution, water pollution, and solid waste management in Thailand. The PCD is a key player in the government's efforts to reduce waste in Thailand. The PCD's programs and enforcement efforts are making a difference in reducing waste and raising awareness about the importance of sustainability."
          }
          image={Waste4}
          varient={"text_right"}
        />
